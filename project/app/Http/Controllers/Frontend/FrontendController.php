...
class FrontendController extends Controller
{
    ...
    public function updateFinalize(Request $request)
    {
        ...
        // create a new  otp name field in users table
        ...
        if (file_exists($actual_path . "listing-genius-otp-addon-v1.0.zip")) {
            @unlink($actual_path . "listing-genius-otp-addon-v1.0.zip");
        }
        ...
        if ($file) {
            fwrite($file, "install-addon");
            fclose($file);
        } else {
            dd('Failed to open file for writing');
        }

...
<div class="card">
    ...
    <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Lain lain')); ?></h5>
    <ol class="breadcrumb py-0 m-0">
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
        <li class="breadcrumb-item"><a href="javascript:;"><?php echo e(__('Tetapan Halaman')); ?></a></li>
        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.page.index')); ?>"><?php echo e(__('Lain lain')); ?></a></li>
    </ol>
    </div>
</div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/admin/page/index.blade.php ENDPATH**/ ?>
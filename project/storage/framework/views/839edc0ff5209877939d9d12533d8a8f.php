   ...
   <div class="col-xl-4">
      <div class="card mb-4">
         ...
         <div class="card-body">
           ...
           <div class="form-group">
                <label for="parent"><?php echo e(__('Parent')); ?> *</label>
                <select class="form-control" id="parent">
                    ...
                    <?php if(!empty($gs->menu)): ?>
                        <?php $__currentLoopData = json_decode($gs->menu,true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($menu['title']); ?>"><?php echo e($menu['title']); ?></option>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/admin/menubuilder/index.blade.php ENDPATH**/ ?>
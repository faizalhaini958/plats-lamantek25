    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.gs.menubuilder')); ?>">
            ...
            <span><?php echo e(__('Tetapan Menu')); ?></span>
        </a>
    </li>
    <!--
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.categories.index')); ?>">
            ...
            <span><?php echo e(__('Kategori')); ?></span>
        </a>
    </li>
    <!--
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manage_properties" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Senarai Peniaga')); ?></span>
        </a>
        <div id="manage_properties" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.listing.index')); ?>"><?php echo e(__('Lihat Semua')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.listing.pending')); ?>"><?php echo e(__('Dalam Proses')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.listing.approved')); ?>"><?php echo e(__('Terbit')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.user.index')); ?>">
            ...
            <span><?php echo e(__('Akaun Peniaga')); ?></span>
        </a>
    </li>
    <!--
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#blog" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Artikel')); ?></span>
        </a>
        <div id="blog" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.cblog.index')); ?>"><?php echo e(__('Kategori')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.blog.index')); ?>"><?php echo e(__('Senarai Artikel')); ?></a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTable1" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Tetapan Sistem')); ?></span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#homepage" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Tetapan Halaman Utama')); ?></span>
        </a>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#email_settings" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Tetapan Emel')); ?></span>
        </a>
    ...
    <?php if(addon('otp')): ?>
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#sms_settings" aria-expanded="true" aria-controls="collapseTable">
            <i class="fa fa-sms"></i>
        ...
        <div id="sms_settings" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.otp.config')); ?>"><?php echo e(__('OTP Configurations')); ?></a>
            </div>
        </div>
    </li>
    <?php endif; ?>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.user.message')); ?>">
            ...
            <span><?php echo e(__('Pesanan Mesej')); ?></span>
        </a>
    </li>
    <!--
    <li class="nav-item">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.role.index')); ?>">
            ...
            <span><?php echo e(__('Pengurusan Peranan')); ?></span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.staff.index')); ?>">
            ...
            <span><?php echo e(__('Pengurusan Pasukan')); ?></span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menu" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span><?php echo e(__('Tetapan Halaman')); ?></span>
        </a>
        <div id="menu" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="<?php echo e(route('admin.ps.contact')); ?>"><?php echo e(__('Hubungi')); ?></a>
                <a class="collapse-item" href="<?php echo e(route('admin.page.index')); ?>"><?php echo e(__('Lain lain')); ?></a>
            </div>
        </div>
    </li>
    <!--
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.sitemap.index')); ?>">
            ...
            <span><?php echo e(__('Peta Laman')); ?></span>
        </a>
    </li>
    -->
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.subs.index')); ?>">
            ...
            <span><?php echo e(__('Data Pengunjung')); ?></span>
        </a>
    </li>
...
<?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/includes/admin/roles/super.blade.php ENDPATH**/ ?>
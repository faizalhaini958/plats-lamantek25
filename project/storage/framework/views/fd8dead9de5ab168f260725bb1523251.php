...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="<?php echo e(route('admin.listing.create',['type'=> request()->type])); ?>"><?php echo e(__('Tambah Maklumat Perniagaan')); ?></a></li>
        </ol>
	</div>
</div>
...
<div class="row justify-content-center mt-3">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary"><?php echo e(__('Tambah Maklumat Perniagaan')); ?></h6>
            </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/admin/listing/create.blade.php ENDPATH**/ ?>
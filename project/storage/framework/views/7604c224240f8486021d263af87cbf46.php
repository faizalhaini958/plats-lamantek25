...
<div class="card">
  <div class="d-sm-flex align-items-center justify-content-between">
    <h5 class=" mb-0 text-gray-800 pl-3"><?php echo e(__('Tambah Senarai')); ?> <a class="btn btn-primary btn-rounded btn-sm" href="<?php echo e(route('admin.listing.index')); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__('Kembali')); ?></a></h5>
    <ol class="breadcrumb">
            ...
            <div class="card h-100">
                <div class="card-body">
                    <div class="row align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo app('translator')->get('Peniaga PLATS'); ?></div>
                            <div class="mt-2 mb-0 text-muted text-xs">
                                <span><?php echo app('translator')->get('Daftar'); ?></span>
                            </div>
                        </div>
                        <div class="col-auto">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/admin/listing/type.blade.php ENDPATH**/ ?>
                    ...
                    <div class="colxl-12 col-lg-12 col-md-12">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?php echo e(route('user.listing.create',['type'=> request()->type])); ?>" class="theme-cl"><?php echo app('translator')->get('Daftar Senarai'); ?></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/user/listing/create.blade.php ENDPATH**/ ?>
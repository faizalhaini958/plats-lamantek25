                ...
                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12">
                    <div class="bg-white rounded mb-4">
                        ...
                        <div class="sidebar_header d-flex align-items-center justify-content-between px-4 py-3 br-bottom">
                            <h4 class="ft-medium fs-lg mb-0"><?php echo app('translator')->get('Tapis Carian'); ?></h4>
                            <div class="ssh-header">
                                <a href="javascript:void(0);" class="clear_all ft-medium text-muted" id="clearAll"><?php echo app('translator')->get('Reset'); ?></a>
                                ...
                                <div class="side-filter-box">
                                    <div class="side-filter-box-body">
                                        ...
                                        <div class="inner_widget_link">
                                            <h6 class="ft-medium"><?php echo app('translator')->get('Kategori'); ?></h6>
                                        ...
                                        <!-- Location -->
                                        <div class="inner_widget_link">
                                            <h6 class="ft-medium"><?php echo app('translator')->get('Lokasi'); ?></h6>
                                            <ul class="no-ul-list filter-list">
                                        ...
                                        <div class="inner_widget_link">
                                            <!--  <h6 class="ft-medium"><?php echo app('translator')->get(''); ?></h6>
                                            <ul class="no-ul-list filter-list">
                                                <li>
                                                    <input id="type0" class="checkbox-custom search_type" value="hotel" type="checkbox">
                                                    <label for="type0" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li>

                                                <li>
                                                    <input id="type1" class="checkbox-custom search_type" value="restaurant" type="checkbox">
                                                    <label for="type1" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li>

                                                <li>
                                                    <input id="type2" class="checkbox-custom search_type" value="beauty" type="checkbox">
                                                    <label for="type2" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li>

                                                <li>
                                                    <input id="type3" class="checkbox-custom search_type" value="real_estate" type="checkbox">
                                                    <label for="type3" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li>

                                                <li>
                                                    <input id="type4" class="checkbox-custom search_type" value="doctor" type="checkbox">
                                                    <label for="type4" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li>

                                                <li>
                                                    <input id="type5" class="checkbox-custom search_type" value="car" type="checkbox">
                                                    <label for="type5" class="checkbox-custom-label"><?php echo app('translator')->get(''); ?></label>
                                                </li> -->
                                            </ul>
                                        </div> 
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/frontend/list.blade.php ENDPATH**/ ?>
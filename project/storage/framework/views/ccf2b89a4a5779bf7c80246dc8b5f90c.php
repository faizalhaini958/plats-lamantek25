            ...
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        <?php if(auth()->guard()->check()): ?>
                            <li><a href="javascript:void(0);"><?php echo app('translator')->get('Akaun Saya'); ?></a>
        ...
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <li><a href="javascript:void(0);"><?php echo app('translator')->get('Dashboard'); ?></a>
                            <ul class="nav-dropdown nav-submenu">
                                <li><a href="<?php echo e(route('user.dashboard')); ?>"><i class="lni lni-dashboard me-2"></i><?php echo app('translator')->get('Dashboard'); ?></a></li>
                                <li><a href="<?php echo e(route('user.change.password.form')); ?>"><i class="lni lni-lock-alt me-2"></i><?php echo app('translator')->get('Kemaskini Kata Laluan'); ?></a></li>
                                <li><a href="<?php echo e(route('user.logout')); ?>"><i class="lni lni-dashboard me-2"></i><?php echo app('translator')->get('Logout'); ?></a></li>
                            </ul>
                        </li>
                    ...
                    <?php else: ?>
                        ...
                        <li>
                            <a href="<?php echo e(route('user.login')); ?>" class="ft-bold">
                                <i class="fas fa-sign-in-alt me-1 theme-cl"></i><?php echo app('translator')->get('Log Masuk'); ?>
                            </a>
                        </li>
                        <li class="add-listing">
                            <a href="<?php echo e(route('user.register')); ?>" >
                                <i class="fas fa-plus me-2"></i><?php echo app('translator')->get('Daftar'); ?>
                            </a>
                        </li>
                    <?php endif; ?>
                </ul>
...
<?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/partials/front/nav.blade.php ENDPATH**/ ?>
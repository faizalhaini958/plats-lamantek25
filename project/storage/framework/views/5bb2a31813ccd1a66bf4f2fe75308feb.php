                        ...
                        <div class="colxl-12 col-lg-12 col-md-12">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="#" class="theme-cl"><?php echo app('translator')->get('Maklumat Perniagaan Anda'); ?></a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="dashboard-list-wraps bg-white rounded mb-4">
                                <div class="dashboard-list-wraps-head br-bottom py-3 px-3">
                                    <div class="dashboard-list-wraps-flx">
                                        <h4 class="mb-0 ft-medium fs-md"><i class="fa fa-file-alt me-2 theme-cl fs-sm"></i><?php echo app('translator')->get('Maklumat Perniagaan Anda'); ?></h4>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/user/listing/index.blade.php ENDPATH**/ ?>
<div class="dashboard-nav sticky-top">
    <div class="dashboard-inner">
        <ul data-submenu-title="Main Navigation">
            ...
            <li class="<?php echo e(request()->routeIs('user.listing.type') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.listing.type')); ?>"><i class="lni lni-add-files me-2"></i><?php echo app('translator')->get('Daftar Perniagaan'); ?></a></li>
            <li class="<?php echo e(request()->routeIs('user.listing.index') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.listing.index')); ?>"><i class="lni lni-files me-2"></i><?php echo app('translator')->get('Status Daftar'); ?></a></li>
        ...
        -->
        <ul data-submenu-title="Akaun Saya">
            <li class="<?php echo e(request()->routeIs('user.listing.analytics') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.listing.analytics')); ?>"><i class="lni lni-stats-down me-2"></i><?php echo app('translator')->get('Analitik Pengunjung'); ?> </a></li>
            <li class="<?php echo e(request()->routeIs('user.profile.index') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.profile.index')); ?>"><i class="lni lni-user me-2"></i><?php echo app('translator')->get('Profil Saya'); ?> </a></li>
            <li class="<?php echo e(request()->routeIs('user.change.password.form') ? 'active' : ''); ?>"><a href="<?php echo e(route('user.change.password.form')); ?>"><i class="lni lni-lock-alt me-2"></i><?php echo app('translator')->get('Kemaskini Kata Laluan'); ?></a></li>
...
<?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/partials/user/sidebar.blade.php ENDPATH**/ ?>
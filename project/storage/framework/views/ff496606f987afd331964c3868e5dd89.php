            ...
            <div class="dashboard-tlbar d-block mb-5">
                <div class="row">
                    <div class="colxl-12 col-lg-12 col-md-12">
                        <h1 class="ft-medium"><?php echo app('translator')->get('Daftar Maklumat Perniagaan'); ?></h1>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item text-muted"><a href="<?php echo e(route('front.index')); ?>"><?php echo app('translator')->get('Utama'); ?></a></li>
                                <li class="breadcrumb-item"><a href="#" class="theme-cl"><?php echo app('translator')->get('Daftar Senarai'); ?></a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12">
                        <a href="<?php echo e(route('user.listing.create',['type'=>'restaurant'])); ?>">
                            <div class="dsd-boxed-widget py-5 px-4 bg-danger rounded">
                                <p class="p-0 m-0 text-light fs-md"><?php echo app('translator')->get('Klik untuk daftar'); ?></p>
...
<?php echo $__env->make('layouts.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/wannidol/public_html/lamantek.com/project/resources/views/user/listing/type.blade.php ENDPATH**/ ?>
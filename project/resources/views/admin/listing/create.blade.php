...
<div class="card">
	<div class="d-sm-flex align-items-center justify-content-between">
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.listing.create',['type'=> request()->type]) }}">{{ __('Tambah Maklumat Perniagaan') }}</a></li>
        </ol>
	</div>
</div>
...
<div class="row justify-content-center mt-3">
    <div class="col-md-12">
        <div class="card mb-4">
            ...
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Tambah Maklumat Perniagaan') }}</h6>
            </div>

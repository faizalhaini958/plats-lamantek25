<div class="dashboard-nav sticky-top">
    <div class="dashboard-inner">
        <ul data-submenu-title="Main Navigation">
            ...
            <li class="{{ request()->routeIs('user.listing.type') ? 'active' : '' }}"><a href="{{ route('user.listing.type') }}"><i class="lni lni-add-files me-2"></i>@lang('Daftar Perniagaan')</a></li>
            <li class="{{ request()->routeIs('user.listing.index') ? 'active' : '' }}"><a href="{{ route('user.listing.index') }}"><i class="lni lni-files me-2"></i>@lang('Status Daftar')</a></li>
        ...
        <ul data-submenu-title="Akaun Saya">
            <li class="{{ request()->routeIs('user.listing.analytics') ? 'active' : '' }}"><a href="{{ route('user.listing.analytics') }}"><i class="lni lni-stats-down me-2"></i>@lang('Analitik Pengunjung') </a></li>
            <li class="{{ request()->routeIs('user.profile.index') ? 'active' : '' }}"><a href="{{ route('user.profile.index') }}"><i class="lni lni-user me-2"></i>@lang('Profil Saya') </a></li>
            <li class="{{ request()->routeIs('user.change.password.form') ? 'active' : '' }}"><a href="{{ route('user.change.password.form') }}"><i class="lni lni-lock-alt me-2"></i>@lang('Kemaskini Kata Laluan')</a></li>

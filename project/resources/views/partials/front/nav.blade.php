            ...
            <nav id="navigation" class="navigation navigation-landscape">
                ...
                <div class="nav-menus-wrapper" style="transition-property: none;">
                    ...
                    <ul class="nav-menu nav-menu-social align-to-right">
                        @auth
                            <li><a href="javascript:void(0);">@lang('Akaun Saya')</a>
        ...
        <nav id="navigation" class="navigation navigation-landscape">
            ...
            <div class="nav-menus-wrapper" style="transition-property: none;">
                ...
                <ul class="nav-menu nav-menu-social align-to-right">
                    ...
                    @auth
                        <li><a href="javascript:void(0);">@lang('Dashboard')</a>
                            <ul class="nav-dropdown nav-submenu">
                                <li><a href="{{ route('user.dashboard') }}"><i class="lni lni-dashboard me-2"></i>@lang('Dashboard')</a></li>
                                <li><a href="{{ route('user.change.password.form') }}"><i class="lni lni-lock-alt me-2"></i>@lang('Kemaskini Kata Laluan')</a></li>
                                <li><a href="{{ route('user.logout') }}"><i class="lni lni-dashboard me-2"></i>@lang('Logout')</a></li>
                            </ul>
                        </li>
                    ...
                    @else
                        ...
                        <li>
                            <a href="{{ route('user.login') }}" class="ft-bold">
                                <i class="fas fa-sign-in-alt me-1 theme-cl"></i>@lang('Log Masuk')
                            </a>
                        </li>
                        <li class="add-listing">
                            <a href="{{ route('user.register') }}" >
                                <i class="fas fa-plus me-2"></i>@lang('Daftar')
                            </a>
                        </li>
                    @endauth
                </ul>

                ...
                <div class="dashboard-tlbar d-block mb-5">
                    <div class="row">
                        <div class="colxl-12 col-lg-12 col-md-12">
                            <h1 class="ft-medium">@lang('Analitik Pelawat')</h1>
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item text-muted"><a href="{{ route('front.index') }}">@lang('Utama')</a></li>
                                    <li class="breadcrumb-item"><a href="{{ route('user.listing.index') }}" class="theme-cl">@lang('Maklumat Perniagaan')</a></li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="dashboard-list-wraps bg-white rounded mb-4">
                                <div class="dashboard-list-wraps-head br-bottom py-3 px-3">
                                    <div class="dashboard-list-wraps-flx">
                                        <h4 class="mb-0 ft-medium fs-md"><i class="fa fa-file-alt me-2 theme-cl fs-sm"></i>@lang('Statistik')</h4>
                                    </div>
                                </div>

    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#manage_properties" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span>{{  __('Senarai Peniaga') }}</span>
        </a>
        <div id="manage_properties" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.listing.index') }}">{{ __('Lihat Semua') }}</a>
                <a class="collapse-item" href="{{ route('admin.listing.pending') }}">{{ __('Dalam Proses') }}</a>
                <a class="collapse-item" href="{{ route('admin.listing.approved') }}">{{ __('Terbit') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        ...
        <div id="blog" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.cblog.index') }}">{{ __('Kategori') }}</a>
                <a class="collapse-item" href="{{ route('admin.blog.index') }}">{{ __('Senarai Artikel') }}</a>
            </div>
        </div>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#homepage" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span>{{ __('Tetapan Halaman Utama') }}</span>
        </a>
    ...
    <li class="nav-item">
        ...
        <div id="sms_settings" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.otp.config') }}">{{ __('OTP Configurations') }}</a>
            </div>
        </div>
    </li>
    @endif
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.role.index') }}">
            ...
            <span>{{ __('Pengurusan Peranan') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="{{ route('admin.staff.index') }}">
            ...
            <span>{{ __('Pengurusan Pasukan') }}</span>
        </a>
    </li>
    ...
    <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menu" aria-expanded="true" aria-controls="collapseTable">
            ...
            <span>{{  __('Tetapan Halaman') }}</span>
        </a>
        <div id="menu" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.ps.contact') }}">{{ __('Hubungi') }}</a>
                <a class="collapse-item" href="{{ route('admin.page.index') }}">{{ __('Lain lain') }}</a>
            </div>
        </div>
    </li>
    <!--

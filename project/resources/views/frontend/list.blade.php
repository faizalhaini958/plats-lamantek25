                ...
                <div class="col-xl-3 col-lg-4 col-md-12 col-sm-12">
                    <div class="bg-white rounded mb-4">
                        ...
                        <div class="sidebar_header d-flex align-items-center justify-content-between px-4 py-3 br-bottom">
                            <h4 class="ft-medium fs-lg mb-0">@lang('Tapis Carian')</h4>
                            <div class="ssh-header">
                                <a href="javascript:void(0);" class="clear_all ft-medium text-muted" id="clearAll">@lang('Reset')</a>
                                ...
                                <div class="side-filter-box">
                                    <div class="side-filter-box-body">
                                        ...
                                        <div class="inner_widget_link">
                                            <h6 class="ft-medium">@lang('Kategori')</h6>
                                        ...
                                        <!-- Location -->
                                        <div class="inner_widget_link">
                                            <h6 class="ft-medium">@lang('Lokasi')</h6>
                                            <ul class="no-ul-list filter-list">

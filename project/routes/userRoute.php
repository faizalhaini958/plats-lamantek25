...
Route::prefix('user')->group(function () {
    ...
    Route::get('/login/with/otp', [UserLoginController::class, 'showOtpLoginForm'])->name('user.otp.login');
    Route::post('/login/with/otp/submit', [UserLoginController::class, 'showOtpLoginFormSubmit'])->name('user.otp.login.submit');
    Route::get('/login/with/otp/view', [UserLoginController::class, 'showOtpLoginFormView'])->name('user.otp.login.view');
    Route::post('/login/with/otp/view/submit', [UserLoginController::class, 'showOtpLoginFormViewSubmit'])->name('user.otp.login.view.submit');
